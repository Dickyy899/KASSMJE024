...
<div class="wrapper">
        ...
        <div class="row">
          <?php foreach ($bulan_pembayaran as $dbp): ?>
            <?php 
              ...
              $total_uang_kas_bulan_ini = mysqli_fetch_assoc(mysqli_query($conn, "SELECT sum(minggu_ke_1 + minggu_ke_4 + minggu_ke_3 + minggu_ke_4) as total_uang_kas_bulan_ini FROM uang_kas WHERE id_bulan_pembayaran = '$id_bulan_pembayaran'"));
  ...
  <strong>Copyright &copy; 2023 BY DICKY HADI PRATAMA </strong>
      All rights reserved. | Repost by <a  target='_blank'>PINJEM DULU SERATUS</a>
      <div class="float-right d-none d-sm-inline-block">
        <b>Version</b> SETEREAH GUA 
    </div>
  </footer>
